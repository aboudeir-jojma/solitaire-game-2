  ...
  });
{
  ...
  window.DOMElementHandler = class extends self.DOMHandler {
    ...
    _OnCreate(e) {
      const t = e.elementId,
        ...
        n =
          ...
          this._GetFocusElement(i)),
        o =
          (n.addEventListener("focus", (e) => this._OnFocus(t)),
          n.addEventListener("blur", (e) => this._OnBlur(t)),
          e.htmlIndex);
      if (
        (s.SetWantHTMLIndex(o), s.SetHTMLZIndex(e.htmlZIndex), this._autoAttach)
      ) {
        const a = this.GetRuntimeInterface().GetAvailableHTMLIndex(o),
          r =
            (s.SetActualHTMLIndex(a),
            this.GetRuntimeInterface().GetHTMLWrapElement(a));
        r.appendChild(i);
      }
    }
    CreateElement(e, t) {
    ...
    PostToRuntimeElement(e, t, i) {
      ((i = i || {}).elementId = t), this.PostToRuntime(e, i);
    }
    _PostToRuntimeElementMaybeSync(e, t, i) {
      ((i = i || {}).elementId = t), this._PostToRuntimeMaybeSync(e, i);
    }
    _OnSetVisible(e) {
      if (this._autoAttach) {
        const t = this._elementMap.get(e.elementId),
          i = t.GetElement();
        t.HadFirstUpdate()
          ? (i.style.display = e.isVisible ? "" : "none")
      ...
      if (this._autoAttach) {
        const t = this._elementMap.get(e.elementId),
          ...
          n =
            ...
            e.fontSize),
          o = (null !== n && (i.style.fontSize = n + "em"), e.htmlIndex),
          a = (t.SetWantHTMLIndex(o), s.GetAvailableHTMLIndex(o));
        if (a !== t.GetActualHTMLIndex()) {
          i.remove();
          const d = s.GetHTMLWrapElement(a);
          d.appendChild(i),
        ...
        r !== t.GetHTMLZIndex() &&
          (t.SetHTMLZIndex(r), s._UpdateHTMLElementsZOrder()),
          t.HadFirstUpdate() ||
            (t.SetHadFirstUpdate(),
        ...
        for (const e of this._elementMap.values()) {
          ...
          if (-1 !== t && -1 !== i && t !== i) {
            const s = e.GetElement(),
              n =
                (s.remove(), this.GetRuntimeInterface().GetHTMLWrapElement(t));
            n.appendChild(s), e.SetActualHTMLIndex(t);
          }
        }
    }
...
{
  const e0 = /(iphone|ipod|ipad|macos|macintosh|mac os x)/i.test(
      navigator.userAgent
    ),
    f0 = /android/i.test(navigator.userAgent),
    g0 =
...
self["${t}"]();`),
  ...
  let s = 0;
  const m0 = 8,
    n0 = ((window.RealFile = window.File), []),
    o0 = new Map(),
    p0 = new Map();
  let r = 0;
  const r0 = [],
  ...
  let t = !1;
  window.RuntimeInterface = class U0 {
    constructor(e) {
      if (
        ...
        ("playable-ad-single-file" !== this._exportType &&
          "playable-ad-zip" !== this._exportType &&
          "instant-games" !== this._exportType) ||
          (this._useWorker = !1),
        g0 && (this._useWorker = !1),
        "cordova" === this._exportType && this._useWorker && f0)
      ) {
      ...
      this.IsAnyWebView2Wrapper()
        ...
        : "macos-wkwebview" === this._exportType &&
          (self.C3WrapperOnMessage = (e) => this._OnWrapperMessage(e)),
    ...
    IsiOSCordova() {
      return e0 && "cordova" === this._exportType;
    }
    IsiOSWebView() {
      const e = navigator.userAgent;
      return (
        (e0 && IsWebViewExportType(this._exportType)) ||
        navigator.standalone ||
        /crios\/|fxios\/|edgios\//i.test(e)
      );
    }
    IsAndroid() {
      return f0;
    ...
    IsAndroidWebView() {
      return f0 && IsWebViewExportType(this._exportType);
    }
    IsWindowsWebView2() {
      return (
    ...
    async _Init(e) {
      ...
      if ("macos-wkwebview" === this._exportType)
        ...
        const s = await this._InitWrapper();
        this._wrapperComponentIds = s.registeredComponentIds;
      }
      if (
        ("playable-ad-single-file" === this._exportType &&
      ...
      if (e.runtimeBaseUrl) this._runtimeBaseUrl = e.runtimeBaseUrl;
        ...
        const n = location.origin,
          o =
            ((this._runtimeBaseUrl =
              ("null" === n ? "file:///" : n) + location.pathname),
            this._runtimeBaseUrl.lastIndexOf("/"));
        -1 !== o &&
          (this._runtimeBaseUrl = this._runtimeBaseUrl.substr(0, o + 1));
      }
    ...
    _GetCommonRuntimeOptions(e) {
      return {
        ...
        isFullscreen: U0.IsDocumentFullscreen(),
          ...
          ("preview" === this._exportType
            ? ((this._worker = new Worker("previewworker.js", {
              ...
              await new Promise((t, i) => {
                const s = (e) => {
                  this._worker.removeEventListener("message", s),
                    (e.data && "ok" === e.data.type ? t : i)();
                };
                this._worker.addEventListener("message", s),
                  this._worker.postMessage({
                    type: "construct-worker-init",
                    import: new URL(n, this._runtimeBaseUrl).toString(),
                  });
              }))
            : (this._worker = await this.CreateWorker(n, {
                type: "module",
                name: "Runtime",
              })),
          document.createElement("canvas")),
        s = ((i.style.display = "none"), i.transferControlToOffscreen()),
        o = (document.body.appendChild(i), document.createElement("div"));
      (o.className = "c3htmlwrap"),
        document.body.appendChild(o),
        this._canvasLayers.push({ canvas: i, htmlWrap: o }),
        (window.c3canvas = i),
        ...
        (this._domHandlers = n0.map((e) => new e(this))),
        this._FindRuntimeDOMHandler(),
        this._runtimeDomHandler._AddDefaultCanvasEventHandlers(i),
        this._runtimeDomHandler._AddDefaultHTMLWrapEventHandlers(o),
    ...
    async _InitDOM(e, t) {
      const i = document.createElement("canvas"),
        ...
        n =
          ...
          this._canvasLayers.push({ canvas: i, htmlWrap: s }),
          (window.c3canvas = i),
          self.C3_InsertHTMLPlaceholders && self.C3_InsertHTMLPlaceholders(),
          (this._domHandlers = n0.map((e) => new e(this))),
          this._FindRuntimeDOMHandler(),
          this._runtimeDomHandler._AddDefaultCanvasEventHandlers(i),
          this._runtimeDomHandler._AddDefaultHTMLWrapEventHandlers(s),
          await Promise.all(
            e.runtimeScriptList.map((e) =>
              this._MaybeGetPlatformSpecificScriptURL(e)
            )
          )),
        o =
          (await Promise.all(n.map((e) => AddScript(e))),
          e.projectMainScriptPath),
        a = e.scriptsInEventsPath;
      if (o)
        try {
          if (
            (await AddScript(o),
          ...
          this._RemoveLoadingMessage(),
            ...
            alert(
              `Failed to load the project main script (${o}). Check all your JavaScript code has valid syntax, all imports are written correctly, and that an exception was not thrown running the script. Press F12 and check the console for error details.`
            );
        }
      if (a)
        try {
      ...
      const r = Object.assign(this._GetCommonRuntimeOptions(e), {
        isInWorker: !1,
        messagePort: t,
        canvas: i,
    ...
    async CreateWorker(e, t) {
      ...
      if ("cordova" === this._exportType && this._isFileProtocol) {
        const n = await this.CordovaFetchLocalFileAsArrayBuffer(e),
          o = new Blob([n], { type: "application/javascript" });
        return new Worker(URL.createObjectURL(o), t);
      }
      ...
      if (s) {
        ...
        return new Worker(URL.createObjectURL(d), t);
      }
    ...
    GetCssDisplayMode() {
      ...
      const e = this.GetExportType(),
        t = new Set(["cordova", "nwjs", "macos-wkwebview"]);
      return t.has(e)
        ? "standalone"
    ...
    _OnUpdateCanvasSize(e) {
      if (!this.IsExportingToVideo()) {
        const t = e.styleWidth + "px",
          ...
          s = e.marginLeft + "px",
          n = e.marginTop + "px";
        for (const { canvas: o, htmlWrap: a } of this._canvasLayers)
          (o.style.width = t),
            (o.style.height = i),
            (o.style.marginLeft = s),
            (o.style.marginTop = n),
            (a.style.width = t),
            (a.style.height = i),
            ...
            this._isFirstSizeUpdate &&
              ((o.style.display = ""), (a.style.display = ""));
    ...
    ["_OnSetHTMLLayerCount"](e) {
      const i = e.count,
        ...
        r = [],
        d = [];
      if (i < this._canvasLayers.length)
        for (; this._canvasLayers.length > i; ) {
          const { canvas: l, htmlWrap: h } = this._canvasLayers.pop();
          h.remove(),
            this._useWorker && !t
              ? this._pendingRemoveElements.push(l)
              : l.remove();
        }
      else if (i > this._canvasLayers.length)
        for (let e = 0, t = i - this._canvasLayers.length; e < t; ++e) {
          const c = document.createElement("canvas");
          if ((c.classList.add("c3overlay"), this._useWorker)) {
            const _ = c.transferControlToOffscreen();
            r.push(_), d.push(_);
          } else r.push(c);
          document.body.appendChild(c);
          const u = document.createElement("div");
          u.classList.add("c3htmlwrap", "c3overlay"),
            document.body.appendChild(u),
            (c.style.width = s),
            (c.style.height = n),
            (c.style.marginLeft = o),
            (c.style.marginTop = a),
            (u.style.width = s),
            (u.style.height = n),
            (u.style.marginLeft = o),
            (u.style.marginTop = a),
            this._runtimeDomHandler._AddDefaultCanvasEventHandlers(c),
            this._runtimeDomHandler._AddDefaultHTMLWrapEventHandlers(u),
            this._canvasLayers.push({ canvas: c, htmlWrap: u });
        }
      for (const m of this._domHandlers)
        m instanceof window.DOMElementHandler && m._OnHTMLLayersChanged();
      return (
        this._UpdateHTMLElementsZOrder(), { addedCanvases: r, transferables: d }
      );
    }
    ...
    _DoUpdateHTMLElementsZOrder() {
      this._RemoveRAFCallback(this._updateHTMLZOrderRAFCallback),
        (this._pendingUpdateHTMLZOrder = !1);
      let e = [];
      for (const o of this._domHandlers)
        if (o instanceof window.DOMElementHandler) {
          const a = o._GetAllElementStatesForZOrderUpdate();
          a && e.push(...a);
        }
      e.sort((e, t) => {
      ...
      for (; s < n; ++s) {
        ...
        r.GetActualHTMLIndex() !== t &&
          (this._DoUpdateHTMLElementsZOrderOnHTMLLayer(t, e.slice(i, s)),
          (t = r.GetActualHTMLIndex()),
          (i = s));
      }
      i < s && this._DoUpdateHTMLElementsZOrderOnHTMLLayer(t, e.slice(i, s));
    }
    _DoUpdateHTMLElementsZOrderOnHTMLLayer(s, n) {
      if (!(n.length <= 1 || s >= this._canvasLayers.length)) {
        const o = n.map((e) => e.GetElement()),
          a = new Set(o),
          r = this.GetHTMLWrapElement(s),
          d = Array.from(r.children).filter((e) => a.has(e));
        let e = 0,
          t = Math.min(o.length, d.length);
        for (; e < t && o[e] === d[e]; ++e);
        let i = e;
        for (; i < t; ++i) d[i].remove();
        for (i = e; i < t; ++i) r.appendChild(o[i]);
      }
    }
    _GetLocalRuntime() {
      ...
      if (o) {
        ...
        if (a) {
          ...
          e && e.then
            ...
            : this._PostResultToRuntime(n, !0, e);
        } else console.warn(`[DOM] No handler '${i}' for component '${t}'`);
    ...
    _OnResultFromRuntime(e) {
      const t = e.responseId,
        ...
        s = e.result,
        n = p0.get(t);
      i ? n.resolve(s) : n.reject(s), p0.delete(t);
    }
    AddRuntimeComponentMessageHandler(e, t, i) {
      let s = o0.get(e);
      if ((s || ((s = new Map()), o0.set(e, s)), s.has(t)))
        throw new Error(`[DOM] Component '${e}' already has handler '${t}'`);
      s.set(t, i);
    }
    static AddDOMHandlerClass(e) {
      if (n0.includes(e)) throw new Error("DOM handler already added");
      n0.push(e);
    }
    ...
    async GetRemotePreviewStatusInfo() {
      return this.PostToRuntimeComponentAsync(
        "runtime",
    ...
    async _MaybeGetPlatformSpecificScriptURL(t) {
      if (
        "cordova" === this._exportType &&
        (t.startsWith("file:") ||
          (this._isFileProtocol && this.IsRelativeURL(t)))
      ) {
        let e = t;
        e.startsWith(this._runtimeBaseUrl) &&
          (e = e.substr(this._runtimeBaseUrl.length));
      ...
      if (this._localFileStrings.hasOwnProperty(t))
        return { isStringSrc: !0, str: this._localFileStrings[t] };
    ...
    CordovaFetchLocalFile(e) {
      const s = window.cordova.file.applicationDirectory + "www/" + e;
      return new Promise((t, i) => {
    ...
    CordovaFetchLocalFileAsArrayBuffer(e) {
      return new Promise((t, i) => {
        k0.push({
          filename: e,
          successCallback: (e) => {
            s--, this._CordovaMaybeStartNextArrayBufferRead(), t(e);
          },
          errorCallback: (e) => {
            s--, this._CordovaMaybeStartNextArrayBufferRead(), i(e);
          },
        }),
    ...
    _HasPermission(i) {
      const s = this._GetPermissionAPI();
      return new Promise((t, e) =>
        s.checkPermission(
          this._MapPermissionID(s, i),
          (e) => t(!!e.hasPermission),
          e
        )
      );
    }
    _RequestPermission(i) {
      const s = this._GetPermissionAPI();
      return new Promise((t, e) =>
        s.requestPermission(
          this._MapPermissionID(s, i),
    ...
    async RequestPermissions(e) {
      if ("cordova" === this.GetExportType() && !this.IsiOSCordova())
        for (const t of e) {
          const i = await this._HasPermission(t);
          if (!i) {
            const s = await this._RequestPermission(t);
            if (!1 === s) return !1;
          }
        }
      return !0;
    ...
    _OnWrapperMessage(e, t) {
      if ("entered-fullscreen" === e)
        U0._SetWrapperIsFullscreenFlag(!0),
          this._runtimeDomHandler._OnFullscreenChange();
      else if ("exited-fullscreen" === e)
        U0._SetWrapperIsFullscreenFlag(!1),
          this._runtimeDomHandler._OnFullscreenChange();
      else if ("object" == typeof e) {
        const i = e.type;
        "directory-handles" === i
          ? (this._directoryHandles = t)
          : "wrapper-init-response" === i
          ? (this._wrapperInitResolve(e), (this._wrapperInitResolve = null))
          : "extension-message" === i
    ...
    async _ConvertDataUriToBlobs(t, i) {
      if ("object" == typeof i)
        (this._localFileBlobs[t] = new Blob([i.str], { type: i.type })),
          (this._localFileStrings[t] = i.str);
      else {
        let e = await this._FetchDataUri(i);
        (e = e || this._DataURIToBinaryBlobSync(i)),
    ...
    _ParseDataURI(e) {
      ...
      return {
        mime_type: o,
        data: (d = (
          "base64" === a || "base64" === r ? atob : decodeURIComponent
        )(s)),
      };
    }
    _BinaryStringToBlob(e, t) {
      let i = e.length,
        s = i >> 2,
        n = new Uint8Array(i),
        o = new Uint32Array(n.buffer, 0, s),
        a,
        r;
      for (a = 0, r = 0; a < s; ++a)
        o[a] =
...
{
  const Kd = self.RuntimeInterface;
  ...
  const Ld = new Map([
    ...
    Md = { dispatchRuntimeEvent: !0, dispatchUserScriptEvent: !0 },
    Nd = { dispatchUserScriptEvent: !0 },
    Od = { dispatchRuntimeEvent: !0 };
  ...
  function FetchImage(s) {
    return new Promise((e, t) => {
      const i = new Image();
      (i.onload = () => e(i)), (i.onerror = (e) => t(e)), (i.src = s);
    });
  }
  ...
  function IsKeyboardInputElement(e) {
    return Pd.has(e.tagName.toLowerCase()) || IsInContentEditable(e);
  }
  const Qd = new Set(["canvas", "body", "html"]);
  function PreventDefaultOnCanvasOrDoc(e) {
    if (e.target.tagName) {
      const t = e.target.tagName.toLowerCase();
      Qd.has(t) && e.preventDefault();
    }
  }
  ...
  let e = !(self.C3_RasterSvgImageBlob = async function (e, t, i, s, n) {
    const o = await BlobToImage(e),
      a = document.createElement("canvas"),
      r = ((a.width = s), (a.height = n), a.getContext("2d"));
    return r.drawImage(o, 0, 0, t, i), a;
  });
  ...
  const Sd = "runtime",
    Td = class extends self.DOMHandler {
      constructor(e) {
        super(e, Sd),
        ...
        if (
          (window.addEventListener("contextmenu", (e) => {
            ...
            s.has(i) || IsInContentEditable(t) || e.preventDefault();
          }),
      ...
      Attach() {
        window.addEventListener("focus", () =>
          ...
          window.addEventListener("focusin", (e) => {
            IsKeyboardInputElement(e.target) &&
          ...
          window.addEventListener("mousedown", (e) =>
            this._OnMouseEvent("mousedown", e, Nd)
          ),
          window.addEventListener("mousemove", (e) =>
            this._OnMouseEvent("mousemove", e, Nd)
          ),
          window.addEventListener("mouseup", (e) =>
            this._OnMouseEvent("mouseup", e, Nd)
          ),
          window.addEventListener("dblclick", (e) =>
            this._OnMouseEvent("dblclick", e, Md)
          ),
          window.addEventListener("wheel", (e) =>
            this._OnMouseWheelEvent("wheel", e, Md)
          ),
      ...
      _OnAndroidVirtualKeyboardChange(t, i) {
        if (
          ((document.body.style.position = ""),
          (document.body.style.overflow = ""),
          (document.body.style.transform = ""),
          (this._vkTranslateYOffset = 0) < i)
        ) {
      ...
      _PostRuntimeEvent(e, t) {
        this.PostToRuntime(e, t || null, Od);
      }
      _GetWindowInnerWidth() {
        ...
        if (!this._isExportToVideo && this._enableWindowResizeEvent) {
          ...
          if (this._iRuntime.IsAndroidWebView()) {
            if (this._enableAndroidVKDetection) {
              if (this._lastWindowWidth === e && t < this._lastWindowHeight)
                return (
                  (this._virtualKeyboardHeight = this._lastWindowHeight - t),
          ...
          this.PostToRuntime("window-resize", {
            ...
            innerHeight: t,
            devicePixelRatio: window.devicePixelRatio,
            isFullscreen: Kd.IsDocumentFullscreen(),
      ...
      _OnFullscreenChange() {
        if (!this._isExportToVideo) {
          const e = Kd.IsDocumentFullscreen();
          e &&
      ...
      _OnKeyEvent(e, t) {
        if (
          void 0 !== t.key &&
          ("Backspace" === t.key && PreventDefaultOnCanvasOrDoc(t),
      ...
      _OnPointerEvent(t, i) {
        if (!this._isExportToVideo) {
          let e = 0;
          "mouse" === i.pointerType && (e = this._mousePointerLastButtons),
            this._PostToRuntimeMaybeSync(
              t,
              {
      ...
      _OnDeviceMotion(s) {
        if (!this._isExportToVideo) {
          let e = null;
          const n = s.acceleration;
          n && (e = { x: n.x || 0, y: n.y || 0, z: n.z || 0 });
          let t = null;
          const o = s.accelerationIncludingGravity;
          o && (t = { x: o.x || 0, y: o.y || 0, z: o.z || 0 });
          let i = null;
          const a = s.rotationRate;
          a &&
            (i = {
              alpha: a.alpha || 0,
              beta: a.beta || 0,
      ...
      _OnDebugHighlight(e) {
        ...
        if (t) {
          ...
          const i = this._debugHighlightElem;
          (i.style.display = ""),
            (i.style.left = e.left - 1 + "px"),
            (i.style.top = e.top - 1 + "px"),
            (i.style.width = e.width + 2 + "px"),
            (i.style.height = e.height + 2 + "px"),
      ...
      _OnScriptCreateWorker(e) {
        const t = e.url,
          ...
          s = e.port2,
          n = new Worker(t, i);
        n.postMessage({ type: "construct-worker-init", port2: s }, [s]);
      }
      _OnAlert(e) {
        alert(e.message);
      }
      _OnScreenReaderTextEvent(e) {
        ...
        if ("create" === t) {
          ...
          (i.id = "c3-sr-" + e.id),
            ...
            this._screenReaderTextWrap.appendChild(i);
        } else if ("update" === t) {
          const s = document.getElementById("c3-sr-" + e.id);
          s
          ...
          const n = document.getElementById("c3-sr-" + e.id);
          n
            ? n.remove()
            : console.warn(
                "[Construct] Missing screen reader text with id " + e.id
  ...
  Kd.AddDOMHandlerClass(Td);
}
{
  const zf = "dispatchworker.js",
    Af = "jobworker.js";
  self.JobSchedulerDOM = class {
    ...
    async Init() {
      ...
      const e = this._runtimeInterface.GetScriptFolder() + zf,
        t =
    ...
    async _CreateJobWorker() {
      const e = this._jobWorkers.length,
        t = this._runtimeInterface.GetScriptFolder() + Af,
  ...
  (self.AudioDOMHandler = class extends self.DOMHandler {
    constructor(e) {
      super(e, Lf),
        ...
        (self.C3Audio_DOMInterface = this).AddRuntimeMessageHandlers([
    ...
    async _CreateAudioContext(e) {
      if (
        (e.usePlayMusicAsSoundWorkaround && (this._playMusicAsSound = !0),
        ...
        const i = { latencyHint: e.latencyHint };
        if (
          (this.SupportsWebMOpus() || (i.sampleRate = 48e3),
          "undefined" != typeof AudioContext)
        )
          this._audioContext = new AudioContext(i);
        else {
          if ("undefined" == typeof webkitAudioContext)
            throw new Error("Web Audio API not supported");
          this._audioContext = new webkitAudioContext(i);
        }
    ...
    _ReconnectEffects(e) {
      ...
      for (const n of this.audioInstancesByEffectTag(e)) n.Reconnect(t);
    ...
    DecodeAudioData(i, e) {
      return e
        ? this._iRuntime._WasmDecodeWebMOpus(i).then((e) => {
            const t = this._audioContext.createBuffer(1, e.length, 48e3),
              i = t.getChannelData(0);
            return i.set(e), t;
          })
        : new Promise((e, t) => {
            this._audioContext.decodeAudioData(i, e, t);
          });
    }
    TryPlayMedia(e) {
    ...
    ReleaseInstancesForBuffer(i) {
      let s = 0;
      for (let e = 0, t = this._audioInstances.length; e < t; ++e) {
        const n = this._audioInstances[e];
        (this._audioInstances[s] = n).GetBuffer() === i ? n.Release() : ++s;
      }
      this._audioInstances.length = s;
    }
    ReleaseAllMusicBuffers() {
      let i = 0;
      for (let e = 0, t = this._audioBuffers.length; e < t; ++e) {
        const s = this._audioBuffers[e];
        (this._audioBuffers[i] = s).IsMusic() ? s.Release() : ++i;
      }
      this._audioBuffers.length = i;
    }
    ...
    *audioInstancesByEffectTag(e) {
    ...
    async _GetAudioInstance(e, t, i, s, n) {
      for (const r of this._audioInstances)
        if (r.GetUrl() === t && (r.CanBeRecycled() || n))
          return r.SetTags(s), r;
      const o = await this._GetAudioBuffer(e, t, i, n),
        a = o.CreateInstance(s);
      return this._audioInstances.push(a), a;
    }
    _AddPendingTags(e) {
      const i = e.join(" ");
      let s = this._pendingTags.get(i);
      if (!s) {
        let t = null;
        const n = new Promise((e) => (t = e));
        (s = { pendingCount: 0, promise: n, resolve: t }),
          this._pendingTags.set(i, s);
      }
      s.pendingCount++;
    }
    _RemovePendingTags(e) {
      ...
      i.pendingCount--,
        0 === i.pendingCount && (i.resolve(), this._pendingTags.delete(t));
    }
    TagsReady(e) {
    ...
    Tick() {
      for (const i of this._analysers) i.Tick();
      const e = this.GetAudioCurrentTime();
      for (const s of this._audioInstances) s.Tick(e);
    ...
    PostTrigger(e, t, i) {
      this.PostToRuntime("trigger", { type: e, tags: t, aiid: i });
    }
    async _Play(e) {
      ...
      if (0 < c && !e.trueClock)
        if (this._audioContext.getOutputTimestamp) {
          const u = this._audioContext.getOutputTimestamp();
          c = c - u.performanceTime / 1e3 + u.contextTime;
    ...
    _Stop(e) {
      const t = e.tags;
      for (const i of this.audioInstancesMatchingTags(t)) i.Stop();
    }
    _StopAll() {
    ...
    _SetPaused(e) {
      const t = e.tags,
        i = e.paused;
      for (const s of this.audioInstancesMatchingTags(t))
        i ? s.Pause() : s.Resume();
    ...
    _SetVolume(e) {
      const t = e.tags,
        i = e.vol;
      for (const s of this.audioInstancesMatchingTags(t)) s.SetVolume(i);
    }
    _SetStereoPan(e) {
      const t = e.tags,
        i = e.p;
      for (const s of this.audioInstancesMatchingTags(t))
        s.SetStereoPannerEnabled(!0), s.SetStereoPan(i);
    }
    async _FadeVolume(e) {
      const t = e.tags,
        i = e.vol,
      ...
      for (const o of this.audioInstancesMatchingTags(t)) o.FadeVolume(i, s, n);
      this._MaybeStartTicking();
    }
    _SetMasterVolume(e) {
    ...
    _SetMuted(e) {
      const t = e.tags,
        i = e.isMuted;
      for (const s of this.audioInstancesMatchingTags(t)) s.SetMuted(i);
    }
    _SetSilent(e) {
    ...
    _SetLooping(e) {
      const t = e.tags,
        i = e.isLooping;
      for (const s of this.audioInstancesMatchingTags(t)) s.SetLooping(i);
    }
    async _SetPlaybackRate(e) {
      const t = e.tags,
        i = e.rate;
      await this.TagsReady(t);
      for (const s of this.audioInstancesMatchingTags(t)) s.SetPlaybackRate(i);
    }
    async _Seek(e) {
      const t = e.tags,
        i = e.pos;
      await this.TagsReady(t);
      for (const s of this.audioInstancesMatchingTags(t)) s.Seek(i);
    }
    async _Preload(e) {
      const t = e.originalUrl,
        i = e.url,
    ...
    _SetSuspended(e) {
      ...
      for (const i of this._audioInstances) i.SetSuspended(t);
    ...
    _OnTick(e) {
      if (
        ...
        for (const s of this._audioInstances) s._UpdatePlaybackRate();
      const t = e.listenerPos,
        i =
          (!t ||
            (this._lastListenerPos[0] === t[0] &&
      ...
      if (
        i &&
        (this._lastListenerOrientation[0] !== i[0] ||
          this._lastListenerOrientation[1] !== i[1] ||
          this._lastListenerOrientation[2] !== i[2] ||
          this._lastListenerOrientation[3] !== i[3] ||
          this._lastListenerOrientation[4] !== i[4] ||
          this._lastListenerOrientation[5] !== i[5])
      ) {
    ...
    async _AddEffect(e) {
      ...
      for (const a of i) {
        if ("filter" === t) n = new self.C3AudioFilterFX(this, ...s);
          ...
          (n = new self.C3AudioConvolveFX(
            this,
            o.GetAudioBuffer(),
            ...s
          ))._SetBufferInfo(e.bufferOriginalUrl, e.bufferUrl, e.bufferType);
    ...
    _SetEffectParam(e) {
      ...
      for (const r of t) {
        ...
        !d || i < 0 || i >= d.length || d[i].SetParam(s, n, o, a);
      }
      this._PostUpdatedFxState();
    }
    _RemoveEffects(e) {
      ...
      for (const i of t) {
        const s = i.toLowerCase(),
          n = this._effects.get(s);
        if (!n || !n.length) return;
        for (const o of n) o.Release();
        this._effects.delete(s), this._ReconnectEffects(s);
      }
    }
    _AddAnalyser(e) {
    ...
    async _OnLoadState(e) {
      ...
      if (3 !== t) {
        const o = [];
        for (const a of this._audioInstances)
          (a.IsMusic() && 1 === t) || (!a.IsMusic() && 2 === t)
            ? o.push(a)
            : a.Release();
        this._audioInstances = o;
      }
      for (const r of this._effects.values()) for (const d of r) d.Release();
      this._effects.clear(),
        (this._timeScale = e.timeScale),
        (this._gameTime = e.gameTime);
      ...
      (this._isSilent = e.isSilent),
        ...
        (this._destinationNode.gain.value = this._masterVolume);
      const n = [];
      for (const l of Object.values(e.effects))
        n.push(Promise.all(l.map((e) => this._AddEffect(e))));
      await Promise.all(n),
    ...
    async _LoadAudioInstance(t, e) {
      if (3 !== e) {
        ...
        if ((!o || 1 !== e) && (o || 2 !== e)) {
          let e = null;
          try {
            e = await this._GetAudioInstance(i, s, n, a, o);
          } catch (e) {
            return void console.error(
          ...
          e.LoadPanState(t.pan),
            e.LoadStereoPanState(t.stereoPan),
            e.Play(r, d, l, 0),
            t.isPlaying || e.Pause(),
            e._LoadAdditionalState(t);
        }
      }
    }
    ...
    async _OnOfflineRenderAudio(e) {
      try {
        ...
        this._hasStartedOfflineRender
          ...
          : (this._audioContext
              .startRendering()
              .then((e) => this._OnOfflineRenderCompleted(e))
              .catch((e) => this._OnOfflineRenderError(e)),
    ...
    _OnOfflineRenderCompleted(i) {
      const s = [];
      for (let e = 0, t = i.numberOfChannels; e < t; ++e) {
        const n = i.getChannelData(e);
        s.push(n.buffer);
      }
    ...
    static EqualsNoCase(e, t) {
      return (
        e === t || e.normalize().toLowerCase() === t.normalize().toLowerCase()
      );
    }
    static ToDegrees(e) {
      return e * Kf;
  ...
  (self.C3WebAudioBuffer = class extends self.C3AudioBuffer {
    ...
    async _Fetch() {
      ...
      if (
        ...
        "playable-ad-single-file" === e.GetExportType() &&
        e.IsRelativeURL(this._url)
      ) {
        const t = e._PlayableAdFetchBlob(this._url);
        this._audioData = await t.arrayBuffer();
      } else {
        const i = await fetch(this._url);
        if (!i.ok)
          throw new Error(
            `error fetching audio data: ${i.status} ` + i.statusText
          );
        this._audioData = await i.arrayBuffer();
      }
    }
    async _Decode() {
      ...
      this._isPannerEnabled !== (e = !!e) &&
        ...
        (this._isPannerEnabled
          ...
          : (this._pannerNode.disconnect(),
            this._gainNode.disconnect(),
            this._gainNode)
        ).connect(this.GetDestinationNode()));
    }
    SetPan(e, t, i, s, n, o, a) {
      if (this._isPannerEnabled) {
        this.SetPanXYZA(e, t, i, s);
        const r = self.AudioDOMHandler.ToDegrees;
        this._pannerConeParams[0] !== r(n) &&
          ((this._pannerConeParams[0] = r(n)),
          (this._pannerNode.coneInnerAngle = r(n))),
          this._pannerConeParams[1] !== r(o) &&
            ((this._pannerConeParams[1] = r(o)),
            (this._pannerNode.coneOuterAngle = r(o))),
          this._pannerConeParams[2] !== a &&
            ((this._pannerConeParams[2] = a),
            (this._pannerNode.coneOuterGain = a));
      }
    }
    SetPanXYZA(e, t, i, s) {
      if (this._isPannerEnabled) {
        ...
        (n[0] === e && n[1] === t && n[2] === i) ||
          ...
          (o[0] === a && o[1] === r && 0 === o[2]) ||
            ...
            (o[1] = r),
            (o[2] = 0),
            this._pannerNode.setOrientation(...o));
      }
    }
    SetStereoPannerEnabled(e) {
      this._isStereoPannerEnabled !== (e = !!e) &&
...
(self.C3Html5AudioInstance = class extends self.C3AudioInstance {
  ...
  (self.C3WebAudioInstance = class extends self.C3AudioInstance {
    ...
    SetLooping(e) {
      this._isLooping !== (e = !!e) &&
        ((this._isLooping = e), this._bufferSource) &&
        (this._bufferSource.loop = e);
    }
    _UpdatePlaybackRate() {
  ...
  });
{
  ...
  (self.C3AudioFilterFX = class extends bj {
    ...
    (self.C3AudioDelayFX = class extends bj {
      constructor(e, t, i, s) {
        super(e),
          (this._type = "delay"),
          (this._params = [t, i, s]),
    ...
    (self.C3AudioConvolveFX = class extends bj {
      constructor(e, t, i, s) {
        super(e),
    ...
    (self.C3AudioFlangerFX = class extends bj {
      constructor(e, t, i, s, n, o) {
        super(e),
          (this._type = "flanger"),
    ...
    (self.C3AudioPhaserFX = class extends bj {
      constructor(e, t, i, s, n, o, a) {
        super(e),
          (this._type = "phaser"),
          (this._params = [t, i, s, n, o, a]),
    ...
    (self.C3AudioGainFX = class extends bj {
      constructor(e, t) {
        super(e),
          (this._type = "gain"),
          (this._params = [t]),
    ...
    (self.C3AudioStereoPanFX = class extends bj {
      constructor(e, t) {
        super(e),
    ...
    (self.C3AudioTremoloFX = class extends bj {
      constructor(e, t, i) {
        super(e),
          (this._type = "tremolo"),
          (this._params = [t, i]),
    ...
    (self.C3AudioRingModFX = class extends bj {
      constructor(e, t, i) {
        super(e),
          (this._type = "ringmod"),
          (this._params = [t, i]),
    ...
    (self.C3AudioDistortionFX = class extends bj {
      constructor(e, t, i, s, n, o) {
        super(e),
      ...
      _SetDrive(e, t) {
        (this._preGain.gain.value = e = e < 0.01 ? 0.01 : e),
      ...
      _Shape(e, t, i) {
        const s = 1.05 * i * t,
          ...
          o = e < 0 ? -1 : 1,
          a = e < 0 ? -e : e;
        let r = a < t ? a : t + n * self.AudioDOMHandler.e4(a - t, 1 / n);
        return (r *= o);
      }
      ConnectTo(e) {
        this._wetNode.disconnect(),
    ...
    (self.C3AudioCompressorFX = class extends bj {
      constructor(e, t, i, s, n, o) {
        super(e),
    ...
    (self.C3AudioAnalyserFX = class extends bj {
      constructor(e, t, i) {
        super(e),
          (this._type = "analyser"),
          (this._params = [t, i]),
...
}
{
  ...
  window.addEventListener(
    "beforeinstallprompt",
    (e) => (e.preventDefault(), (t = e), i && i._OnBeforeInstallPrompt(), !1)
  );
  const dl = "browser",
    el = class extends self.DOMHandler {
      constructor(e) {
        super(e, dl),
          (this._exportType = ""),
          this.AddRuntimeMessageHandlers([
      ...
      Attach() {
        t ? this._OnBeforeInstallPrompt() : (i = this),
      ...
      async _OnRequestInstall() {
        if (!t) return { result: "unavailable" };
        try {
          t.prompt();
          const e = await t.userChoice;
          return { result: e.outcome };
        } catch (e) {
          return (
            console.error("[Construct] Requesting install failed: ", e),
            { result: "failed" }
          );
        }
      }
      ...
      _OnNavigate(e) {
        ...
        if ("back" === t)
          ...
          self.cordova && self.cordova.InAppBrowser
            ? self.cordova.InAppBrowser.open(i, "_system")
            : "preview" === n || this._iRuntime.IsAnyWebView2Wrapper()
          ...
          const o = e.url,
            a = e.tag;
          self.cordova && self.cordova.InAppBrowser
            ? self.cordova.InAppBrowser.open(o, "_system")
            : window.open(o, a);
        }
      }
      _OnRequestFullscreen(t) {
        if (
          ...
          const i = { navigationUI: "auto" },
            s = t.navUI,
            n =
              (1 === s
                ? (i.navigationUI = "hide")
                : 2 === s && (i.navigationUI = "show"),
              document.documentElement);
          let e;
          n.requestFullscreen
            ? (e = n.requestFullscreen(i))
            : n.mozRequestFullScreen
            ? (e = n.mozRequestFullScreen(i))
            : n.msRequestFullscreen
            ? (e = n.msRequestFullscreen(i))
            : n.webkitRequestFullScreen &&
              (e =
                void 0 !== Element.ALLOW_KEYBOARD_INPUT
                  ? n.webkitRequestFullScreen(Element.ALLOW_KEYBOARD_INPUT)
                  : n.webkitRequestFullScreen()),
            e instanceof Promise && e.catch(noop);
        }
      }
      _OnExitFullscreen() {
        if (
          ...
          document.exitFullscreen
            ...
            : document.webkitCancelFullScreen &&
              (e = document.webkitCancelFullScreen()),
            e instanceof Promise && e.catch(noop);
        }
      }
      _OnSetHash(e) {
      ...
      _OnGetDocumentCSSStyle(e) {
        ...
        try {
          ...
          if (s) {
            ...
            return { isOk: !0, result: n.getPropertyValue(t) };
          }
          return { isOk: !1 };
        } catch (e) {
          return (
            console.warn("[Browser] Failed to get style: ", e), { isOk: !1 }
          );
        }
      }
      _OnSetWindowSize(e) {
  ...
  self.RuntimeInterface.AddDOMHandlerClass(el);
}
{
  const sm = "mouse",
    tm = class extends self.DOMHandler {
      constructor(e) {
        super(e, sm),
          this.AddRuntimeMessageHandlers([
  ...
  self.RuntimeInterface.AddDOMHandlerClass(tm);
}
{
  const Cm = "touch",
    Dm = class extends self.DOMHandler {
      constructor(e) {
        super(e, Cm),
  ...
  self.RuntimeInterface.AddDOMHandlerClass(Dm);
}
{
  const Om = "localstorage",
    Pm = class extends self.DOMHandler {
      constructor(e) {
        super(e, Om),
          this.AddRuntimeMessageHandlers([
            ["init", () => this._Init()],
  ...
  self.RuntimeInterface.AddDOMHandlerClass(Pm);
}
