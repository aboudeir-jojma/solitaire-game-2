...
(function () {
  ...
  if (missingFeatures.length === 0 && !isKasperskyScriptInjected)
    ...
    if (/android/i.test(ua))
      ...
      msgText +=
        "<br><br>Note: <strong>Internet Explorer</strong> and the <strong>legacy Edge browser</strong> are not supported. Try using <a href=''>Chrome</a> or <a href=''>Firefox</a> instead.";
