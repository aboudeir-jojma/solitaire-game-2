...
var _azerionIntegration = {
  gdId: "44d7c05ce7794f71a96aaa810da0dd06",
  rtgEnabled: false,
  lbEnabled: false,
  fbType: "dummy",
  alxType: "none",
  ...
  playBtn: true,
  cp: false,
  build: { version: "tc-17", timeStamp: 1732108977766, h: "c806b10c" },
  p: "gd",
  lng: null,
  gmoEnabled: false,
...
(() => {
        ...
        Object.create &&
          ...
          (t.prototype.emit = function (e, t, n, i, r, o) {
            ...
            if (d.fn) {
              ...
              for (h = 1, s = new Array(l - 1); h < l; h++)
                s[h - 1] = arguments[h];
              d.fn.apply(d.context, s);
            } else
              for (var c, u = d.length, h = 0; h < u; h++)
                switch (
                  (d[h].once && this.removeListener(e, d[h].fn, void 0, !0), l)
                ) {
                  case 1:
                  ...
                  case 2:
                    ...
                    break;
                  case 3:
                    d[h].fn.call(d[h].context, t, n);
                    break;
                  case 4:
                    d[h].fn.call(d[h].context, t, n, i);
                    break;
                  default:
                    if (!s)
                      for (c = 1, s = new Array(l - 1); c < l; c++)
                        s[c - 1] = arguments[c];
                    d[h].fn.apply(d[h].context, s);
                }
            return !0;
          }),
          ...
          (t.prototype.removeAllListeners = function (e) {
            return (
              e
                ? ((e = p ? p + e : e), this._events[e] && d(this, e))
                : ((this._events = new n()), (this._eventsCount = 0)),
              this
            );
          }),
          ...
          (t = function (e, t, r, n) {
            ...
            Object.defineProperty(t, "__esModule", { value: !0 }),
              ...
              (a.prototype.showAd = function (t) {
                ...
                this.adsEnabled
                  ? void 0 === window.gdsdk ||
                    (window.gdsdk && void 0 === window.gdsdk.showAd)
                    ? ((this.adsEnabled = !1),
                      this.adManager.emit(r.AdEvents.CONTENT_RESUMED))
                    : window.gdsdk
                        .showAd(
                          t === r.AdType.rewarded ? i.rewarded : i.interstitial
                        )
                        .catch(function (e) {
                          t === r.AdType.rewarded &&
                            n.hasRewarded &&
          ...
          (t = function (e, t, n, i) {
            ...
            Object.defineProperty(t, "__esModule", { value: !0 }),
              ...
              (r.prototype.loadBanner = function () {
                return void 0 === window.gdsdk
                  ? Promise.reject(
                      "GD Sdk not available, probably due to adblocker"
                    )
                  : window.gdsdk.showAd(n.GameDistributionAdType.display, {
            ...
            Object.defineProperty(t, "__esModule", { value: !0 }),
                ...
                this.adsEnabled
                  ? void 0 === window.gdsdk ||
                    ...
                    : window.gdsdk
                        .showAd(
                          t === r.AdType.rewarded
                            ? i.GameDistributionAdType.rewarded
                            : i.GameDistributionAdType.interstitial
                        )
                        .catch(function (e) {
                          t === r.AdType.rewarded &&
                            n.hasRewarded &&
              ...
              (o.prototype.preloadAd = function (e) {
                ...
                !this.hasRewarded &&
                  ...
                  (console.log("preloading ad"),
                  window.gdsdk
                    .preloadAd(i.GameDistributionAdType.rewarded)
                    .then(function () {
                      (t.hasRewarded = !0),
                        t.adManager.emit(r.AdEvents.AD_LOADED, e);
                    }));
  ...
  ((e, t) => {
    ...
    e(function (e, I) {
      ...
      function g(e, t) {
        e._state === O && ((e._state = B), (e._result = t), D(n, e));
      }
      function a(e, t, n, i) {
      ...
      var v, b, _, A, D, S, x, E, T, k, C, O, P, B, L, R, M;
      e.exports =
        ((v =
          Array.isArray ||
          function (e) {
        ...
        (A = _ = void (b = 0)),
        (D = function (e, t) {
          (T[b] = e), (T[b + 1] = t), 2 === (b += 2) && (A ? A(i) : k());
        }),
        (e = "undefined" != typeof window ? window : void 0),
        (x = (S = e || {}).MutationObserver || S.WebKitMutationObserver),
        (S =
          "undefined" == typeof self &&
    ...
    Object.defineProperty(l, "instance", {
      get: function () {
        return (l.classInstance =
          void 0 === l.classInstance ? new l() : l.classInstance);
      },
      enumerable: !1,
      configurable: !0,
    }),
      (l.prototype.load = function (t, e, n) {
        var i = this;
        return this.contains(t)
          ? Promise.reject("Already in cache.")
          : ((this.cache[t] = { url: e, data: null }),
            this.requestXhr(e, n)
              .then(function (e) {
      ...
      (l.prototype.loadComplete = function (e, t) {
        if (!this.contains(e))
      ...
      (l.prototype.isLoading = function (e) {
        return this.contains(e) && null === this.cache[e].data;
      }),
      (l.prototype.isLoaded = function (e) {
        return this.contains(e) && null !== this.cache[e].data;
      }),
      (l.prototype.loadScript = function (i, e, r) {
            ...
            ? ((r = new XMLHttpRequest()),
              new Promise(function (e, t) {
                r.onreadystatechange = function () {
                  4 === r.readyState &&
                    (200 === r.status
                      ? (e(r.responseText), (r.onreadystatechange = null))
                      : 0 < r.status &&
                        (t(
    ...
    (o.BrandingDomain = void 0),
      ((k = o.BrandingDomain || (o.BrandingDomain = {}))[(k.Neutral = 0)] =
        "Neutral"),
      (k[(k.Yepi = 1)] = "Yepi"),
      (k[(k.Spele = 2)] = "Spele"),
      (k[(k.Funnygames = 3)] = "Funnygames"),
      (k[(k.Kizi = 4)] = "Kizi"),
      (k[(k.PlayCell = 5)] = "PlayCell"),
      (k[(k.GameCell = 6)] = "GameCell"),
      (k[(k.Bild = 7)] = "Bild"),
      (k[(k.AGame = 8)] = "AGame"),
      (k[(k.Admeen = 9)] = "Admeen"),
      (k[(k.PlayTime = 10)] = "PlayTime"),
      (k[(k.Zigiz = 11)] = "Zigiz"),
      (p.isBip = function () {
        return (
    ...
    function p() {}
    (o.UtmTargets = void 0),
      ((k = o.UtmTargets || (o.UtmTargets = {}))[(k.splashscreen = 0)] =
        "splashscreen"),
      (k[(k.logo = 1)] = "logo"),
      (k[(k.facebook = 2)] = "facebook"),
      (k[(k.twitter = 3)] = "twitter"),
      (k[(k.playstore = 4)] = "playstore"),
      (k[(k.appstore = 5)] = "appstore"),
      (k[(k.more_games = 6)] = "more_games"),
      (k[(k.download_game = 7)] = "download_game"),
      (k[(k.walkthrough = 8)] = "walkthrough"),
      (k[(k.disclaimer = 9)] = "disclaimer"),
      (k[(k.highscores = 10)] = "highscores"),
      ...
      (g.getPromoURL = function (e, t, n, i, r) {
        return window.hasOwnProperty("_YaSDK") ||
          ...
          : e === o.BrandingDomain.Admeen
          ? ""
          : e === o.BrandingDomain.Bild
          ? t
          : t +
            "/?utm_source=" +
            n +
    ...
    (S.loadHost = function () {
      ...
      (S.getSourceSite = function (e) {
        ...
        return (
          -1 !==
            ...
            (t = S.getUrlParameter("gd_sdk_referrer_url") || t),
      ...
      (S.getRandomRange = function (e, t) {
        return (Math.random() * (t - e) + e) | 0;
      }),
      (S.getUrlParameter = function (e) {
        e = e.replace(/[\[]/, "\\[").replace(/[\]]/, "\\]");
        e = new RegExp("[\\?&]" + e + "=([^&#]*)").exec(location.search);
        return null === e ? "" : decodeURIComponent(e[1].replace(/\+/g, " "));
      }),
      (S.intTimeToString = function (e) {
      ...
      (S.LANGUAGE = "en"),
      (S.HOST = document.referrer || window.location.host),
      (S.ASSET_LOCATION = v.isStandAlone()
        ? "assets/"
        : "");
    var D = S;
    function S() {}
    (E.getUrlParams = function (e, t) {
      ...
      (E.hasBooleanValue = function (e, t) {
        e = E.getUrlParams(e, t);
        return !!e && "true" === e;
      }),
      (E.enableDebugMode = function () {
        return E.hasBooleanValue("azerionIntegrationDebug", E.search);
      }),
      (E.showVersioning = function () {
        return E.hasBooleanValue("showAzVersion", E.search);
      }),
      (E.getBuildInfo = function (e) {
        var t = {
          build: { version: "", commit: "", timeStamp: new Date() },
          gdId: "",
        };
        try {
          var n = e.build,
      ...
      (E.showBuildInfo = function (e) {
        ...
        (E.search = e),
          E.enableDebugMode() &&
            ...
            (t = E.getBuildInfo(window._azerionIntegration)),
    ...
    var T = e(function (e, t) {
        e.exports = (function n(i, r, o) {
          ...
          for (var s = d, e = 0; e < o.length; e++) a(o[e]);
          return a;
        })(
          {
            1: [
              function (e, j, G) {
                !function () {
                  var c,
                    ...
                    v =
                      ...
                      (C.prototype.setConfig = function (e) {
                        ...
                        return (
                          D(i, n),
                          (this._easing = k(n, e.easing || "linear")),
                          (this._filterArgs = [
                            n,
                            this._originalState,
                            i,
                      ...
                      "object" == typeof G
                        ? (j.exports = C)
                        : void 0 === w.Tweenable && (w.Tweenable = C),
                      C);
                  function b() {}
                  function _(e, t) {
                  ...
                  function E(t, n) {
                    var i = C.prototype.filter,
                      r = t._filterArgs;
                    _(i, function (e) {
                      void 0 !== i[e][n] && i[e][n].apply(t, r);
                    });
                  }
                  function T(e, t, n, i, r, o, a, s, d, l, c) {
                    (p = t + n + i),
                      (u = Math.min(c || f(), p)),
                      (h = p <= u),
                      (p = i - (p - u)),
                      e.isPlaying() &&
                        (h
                          ? (d(a, e._attachment, p), e.stop(!0))
                          : ((e._scheduleId = l(e._timeoutHandler, 1e3 / 60)),
                            E(e, "beforeTween"),
                            u < t + n
                              ? S(1, r, o, a, 1, 1, s)
                              : S(u, r, o, a, i, t + n, s),
                          ...
                          (((1 - (n = 3 * s) - (t = 3 * ((i = f) - s) - n)) *
                            (i = ((e, t) => {
                              for (var n, i, r, o, a = e, s = 0; s < 8; s++) {
                                if (l((r = d(a) - e)) < t) return a;
                                if (l((o = (3 * c * a + 2 * u) * a + h)) < 1e-6)
                                  break;
                                a -= r / o;
                              }
                              if ((a = e) < (n = 0)) return n;
                    ...
                    (l.prototype.filter.token = {
                      ...
                      beforeTween: function (e, t, n, i) {
                        var s = i,
                          d = this._tokenData;
                        l.each(d, function (e) {
                          var t = d[e].chunkNames,
                            n = t.length,
                            i = s[e];
                          if ("string" == typeof i)
                            for (
                              var r = i.split(" "), o = r[r.length - 1], a = 0;
                              a < n;
                              a++
                            )
                              s[t[a]] = r[a] || o;
              ...
              function (e, t, n) {
                function i(e, t) {
                  ...
                  (t = d.extend(
                    ...
                    (e = d.isString(e) ? document.querySelector(e) : e),
                    (this.path = e),
                    (this._opts = t),
                ...
                (i.prototype.value = function () {
                  ...
                  (i.prototype.animate = function (e, n, t) {
                    (n = n || {}), d.isFunction(n) && ((t = n), (n = {}));
                    var i = d.extend({}, n),
                      r = d.extend({}, this._opts),
                      r = ((n = d.extend(r, n)), this._easing(n.easing)),
                    ...
                    (this._tweenable = new s()),
                      this._tweenable.tween({
                        from: d.extend({ offset: o }, i.from),
                        to: d.extend({ offset: e }, i.to),
                        duration: n.duration,
                        easing: r,
                        step: function (e) {
                ...
                function i(e, t) {
                  ...
                  if (0 !== arguments.length) {
                    ...
                    (this._container = n),
                      ...
                      this._opts.svgStyle &&
                        o.setStyles(t.svg, this._opts.svgStyle),
                      (this.svg = t.svg),
                      (this.path = t.path),
                      (this.trail = t.trail),
                      (this.text = null);
                  ...
                  (i.prototype._createSvgView = function (e) {
                    var t = document.createElementNS(
                      ...
                      e =
                        ...
                        this._createPath(e));
                    return t.appendChild(e), { svg: t, path: e, trail: n };
                  }),
                  (i.prototype._initializeSvg = function (e, t) {
      ...
      k =
          ...
          return c(this, void 0, void 0, function () {
            ...
            return u(this, function (e) {
              switch (e.label) {
                case 0:
                  return (
                    x.showBuildInfo(window.location.search),
                    (r =
                    ...
                    (this.circleLoader = new T.Circle("#h5branding-bar", {
                      strokeWidth: 3,
                      color: this.options.barColor,
                    })),
                    (a = document.getElementById("h5branding-version")) &&
                      (a.innerHTML = this.options.version),
                    [4, this.loadLibs()]
                  );
                case 1:
                ...
                case 1:
                  return (
                    ...
                    (t = document.getElementById("h5branding-logo")) &&
                      D.getBrandingDomain() !== o.BrandingDomain.Neutral &&
        ...
        (C.prototype.setScriptloadProgress = function (e, t) {
          this.circleLoader.animate((0.3 * t) / e, null, function () {});
        }),
        (C.prototype.setLoadProgress = function (e) {
          var t,
            n = this;
          this.loaded &&
        ...
        (C.prototype.setButtonCallback = function (e) {
